...
void ContourVariablesSubtab::Update(VAPoR::DataMgr *dataMgr, VAPoR::ParamsMgr *paramsMgr, VAPoR::RenderParams *rParams)
{
...
void ContourAppearanceSubtab::SetContourValues(int contourCount, double contourMin, double spacing)
{
    vector<double> cVals;
