...
public:
    PLODSelectorHLI() : PLODSelector(), PWidgetHLIBase<VAPoR::RenderParams, double>((PWidget *)this, &VAPoR::RenderParams::GetCompressionLevel, &VAPoR::RenderParams::SetCompressionLevel) {}
};

class PRefinementSelectorHLI : public PRefinementSelector, public PWidgetHLIBase<VAPoR::RenderParams, double> {
public:
    PRefinementSelectorHLI() : PRefinementSelector(), PWidgetHLIBase<VAPoR::RenderParams, double>((PWidget *)this, &VAPoR::RenderParams::GetRefinementLevel, &VAPoR::RenderParams::SetRefinementLevel)
    {
    }
};
