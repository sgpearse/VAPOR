...
VGeometry::VGeometry(const std::vector<double> &range, const std::vector<std::string> &label) : VGeometry(nullptr, range, label) {}
...
void VGeometry::SetRange(const std::vector<double> &range)
{
    ...
    if (_dim == 3) _zrange->SetExtents(range[ZMIN], range[ZMAX]);
}
...
void VGeometry::SetGeometry(const std::vector<double> &vals)
{
    ...
    if (_dim == 3) _zrange->SetSelection(vals[ZMIN], vals[ZMAX]);
}
...
void VGeometry::GetGeometry(std::vector<double> &vals) const
{
    ...
    if (_dim == 3) _zrange->GetSelection(vals[ZMIN], vals[ZMAX]);
}
