...
public:
    VRange(QWidget *parent = nullptr, double min = 0.0, double max = 1.0, const std::string &minLabel = "Min", const std::string &maxLabel = "Max");
    VRange(double min = 0.0, double max = 1.0, const std::string &minLabel = "Min", const std::string &maxLabel = "Max");
    ~VRange();
