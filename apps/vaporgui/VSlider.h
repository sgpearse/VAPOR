...
public:
    VSlider(QWidget *parent = nullptr, const std::string &label = "VSlider", double min = 0, double max = 100, double value = 0);
    VSlider(const std::string &label = "VSlider", double min = 0, double max = 100, double value = 0);
    ~VSlider();
