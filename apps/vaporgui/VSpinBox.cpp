...
VSpinBox::VSpinBox(QWidget *parent, const std::string &labelText, int min, int max, int defaultValue) : VLabel(parent, labelText), _min(min), _max(max), _value(defaultValue)
{
...
VSpinBox::VSpinBox(const std::string &labelText, int min, int max, int defaultValue) : VSpinBox(nullptr, labelText, min, max, defaultValue) {}
