...
{
    // Add(
    layout()->addWidget(new PEnumDropdownHLI<VAPoR::RenderParams>("Dimensionality HLI", {"2D", "3D"}, {2, 3}, &VAPoR::RenderParams::GetRefinementLevel, &VAPoR::RenderParams::SetRefinementLevel));
    /*_dimDropdown = new
        new PEnumDropdown(
            "",
            {"2D", "3D"},
...
void VariablesWidget2::_dimChanged() { cout << "dim changed to " << _dimComboBox->GetValue() << endl; }
