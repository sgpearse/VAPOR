...
AnnotationParams::AnnotationParams(const AnnotationParams &rhs
) : ParamsBase(rhs) {
...
void AnnotationParams::GetDomainColor(double color[3]) const {
...
void AnnotationParams::SetAxisArrowEnabled( bool enabled ) {
	SetValueLong(AxisArrowEnabledTag, "Set axis arrow to enabled/disabled", (long)enabled);
}

void AnnotationParams::SetAxisArrowSize(double val){
	SetValueDouble(AxisArrowSizeTag, "Set axis arrow size", val);
}

void AnnotationParams::SetAxisArrowXPos(double val){
	SetValueDouble(AxisArrowXPosTag, "Set axis arrow X coordinate", val);
}

void AnnotationParams::SetAxisArrowYPos(double val){
	SetValueDouble(AxisArrowYPosTag, "Set axis arrow Y coordinate", val);
}

bool AnnotationParams::GetAxisArrowEnabled() const {
    return (bool)GetValueLong(AxisArrowEnabledTag, false);
}

double AnnotationParams::GetAxisArrowSize() const {
	return GetValueDouble(AxisArrowSizeTag, .2);
}

double AnnotationParams::GetAxisArrowXPos() const {
	return GetValueDouble(AxisArrowXPosTag, .05);
}

double AnnotationParams::GetAxisArrowYPos() const {
	return GetValueDouble(AxisArrowYPosTag, .05);
}
