...
OSPRayParams::OSPRayParams(ParamsBase::StateSave *ssave) : ParamsBase(ssave, _classType) { _init(); }
...
OSPRayParams::OSPRayParams(const OSPRayParams &rhs) : ParamsBase(new ParamsBase::StateSave, _classType) { _init(); }
...
void OSPRayParams::SetNumThreads(int val) { SetValueLong(_numThreadsTag, "Number of execution threads", val); }
