...
OSPTexture OSPRayGetDepthTextureFromOpenGLPerspective(const double &fovy, const double &aspect, const double &zNear, const double &zFar, const glm::vec3 &cameraDir, const glm::vec3 &cameraUp,
                                                      const float *glDepthBuffer, const int &width, const int &height)
{
