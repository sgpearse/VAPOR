...
OptionParser::OptDescRec_T set_opts[] = {{"dims", 1, "64x64x64",
...
OptionParser::Option_T get_options[] = {{"dims", Wasp::CvtToSize_tVec, &opt.dims, sizeof(opt.dims)},
...
void CompareIndexToCoords(Grid &  grid,
...
StretchedGrid *MakeStretchedGrid(const vector<size_t> &dims, const vector<size_t> &bs, const std::vector<double> &minu, const std::vector<double> &maxu)
{
